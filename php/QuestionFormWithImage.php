  ...
  <section class="main" id="s1">
    <div style="border-style:solid;border-color:black; font-family: Verdana,Geneva,sans-serif; text-align:left;"> <p style="text-align:center;">DATOS DE LA PREGUNTA</p>
		<form id='fquestion' name='fquestion' action='AddQuestion.php'>
			...
			Respuesta incorrecta 2*: <input type="text" id="incorrecta2" size=55><span id="eincorrecta2"></span><br>
			Respuesta incorrecta 3*: <input type="text" id="incorrecta3" size=55><span id="eincorrecta3"></span><br>
			...
			Tema de la pregunta*: <input type="text" id="tema" size=55><span id="etema"></span><br>
